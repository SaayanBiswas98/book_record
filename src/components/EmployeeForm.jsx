            ...
            <div className="card border-primary p-5 m-5">
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        <label className="form-label mt-2" htmlFor="inputValid">Book Name</label>
                        <input
                            name="name"
                            type="text"
                    ...
                    <div className="form-group">
                        <label className="form-label mt-2" htmlFor="inputValid">Isbn Number</label>
                        <input
                            type="number"
                            name="address"
                    ...
                    <div className="form-group">
                        <label className="form-label mt-2" htmlFor="inputValid">Year Published</label>
                        <input
                            name="phone"
                            type="number"
                    ...
                    <div className="d-grid gap-2 mt-3">
                        <button type="submit" className="btn btn-outline-primary btn-block">{id ? "Edit" : "Add"} Books</button>
                    </div>
                </form>
            </div>
